...
class UpdatePriceView(APIView):
    ...
    def patch(self, request, pk):
        ...
        return Response({"message": "Price updated successfully (PATCH)", "id": item.id, "price": item.price})
    ...
    def put(self, request, pk):
        ...
        return Response({"message": "Price updated successfully (PUT)", "id": item.id, "price": item.price})
